    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefereeLeague", x => new { x.RefereeId, x.LeagueId });
                    table.ForeignKey(
                        name: "FK_RefereeLeague_Leagues_LeagueId",
                        column: x => x.LeagueId,
                        principalTable: "Leagues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RefereeLeague_Referees_RefereeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefereeLeague_LeagueId",
                table: "RefereeLeague",
                column: "LeagueId");
        }
